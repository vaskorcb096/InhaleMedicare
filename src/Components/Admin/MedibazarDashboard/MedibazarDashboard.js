        ...
        <div className="container-fluid row ">
          ...
          <div className="dashboard_container  text-center">
              ...
              <div style={{color:'white'}} className="mt-3 row">
                ...
                <Link style={{ textDecoration: 'none' }} className="text-white styleddash "  to="/addProduct" >
                  <div style={{backgroundColor:'#842d72'}}className="card">
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                         <img className="p-2" style={{height:'90px'}} src={images01} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
                  <Link style={{ textDecoration: 'none' }} className="text-white styleddash "  to="/manageProduct">
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
                  ...
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                          <img style={{height:'48px',width:'48px'}} src={images04} alt=""/>
                      <h2 className="todaypattient">96</h2>

                      </div>
                    
                     
                      <h5 className="p-1" style={{marginLeft:'0.5em'}}> Order List</h5>
