...
const Dashboard = () => {
    return (
        <section id="dashboard">
            ...
            <h1 className="mr-0">Appointments</h1>
          <div className="dashboard_container  text-center">
              ...
              <div style={{color:'white'}} className="mt-3 row">
                ...
                <Link style={{ textDecoration: 'none' }}  className="text-white styleddash "  to="/totalAppointments" >
                  <div style={{backgroundColor:'#842d72'}}className="card">
                  <div className="card-body d-flex  align-items-center justify-content-center">
                      <div>
                         <img className="p-1" style={{height:'48px'}}src={images10} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }}  className="text-white styleddash "  to="/todayAppointments" >
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }}  className="text-white styleddash "  to="/successfullAppointments" >
              <div  style={{backgroundColor:'#ffb037'}} className="card">
                  <div className="card-body d-flex">
                      ...
                      <h5 className="pt-3" style={{marginLeft:'0.5em'}}>Successfull Appointments</h5>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }}  className="text-white styleddash "  to="/pendingAppointments" >
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }}  className="text-white styleddash " to="/serviceSection" >
                  <div 
                  
                  style={{backgroundColor:'#293250'}}className="card">
              
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                         <img className="p-2" style={{height:'90px'}} src={images11} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }} className="text-white styleddash " to="/manageService" >
              <div  style={{backgroundColor:'#6DD47E'}} className="card">
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                          <img className="p-2" style={{height:'90px'}}src={images04} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
                  ...
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                         <img  className="p-2" style={{height:'90px'}} src={images09} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
                  ...
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                         <img className="p-2" style={{height:'90px'}} src={images08} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }}  className="text-white styleddash " to="/addDoctor" >
              <div style={{backgroundColor:'#210070'}}className="card">
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                         <img className="p-2" style={{height:'90px'}}src={images07} alt=""/>
              ...
              <div className="mb-3 col-lg-3 col-md-6 " >
              <Link style={{ textDecoration: 'none' }}  className="text-white styleddash " to="/manageDoctor" >
              <div style={{backgroundColor:'#00E1D9'}}className="card">
                  <div className="card-body d-flex align-items-center justify-content-center">
                      <div>
                         <img className="p-1" style={{height:'90px'}} src={images05} alt=""/>
